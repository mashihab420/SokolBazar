...
import com.example.sokolbazar.ModelClass.EventModel;
import com.example.sokolbazar.ModelClass.ImageSenderInfo;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    public void uploadButtonClicked(View view) {
        ...
        NetworkCall.fileUpload(filePath,
                new ImageSenderInfo(name, age));
