...
public class SeeAllProductAdapter extends RecyclerView.Adapter<SeeAllProductAdapter.MyViewHolder> {
    ...
    public SeeAllProductAdapter(List<ModelProducts> allproduct, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_see_all_product,parent,false);
